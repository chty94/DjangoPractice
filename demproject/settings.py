"""
Django settings for demproject project.
...
SECRET_KEY = 'l1^2&i#-8(4)rvi)#74%m^p*dn4vuh+oxi9bryeupced$bs42^'
...
WSGI_APPLICATION = 'demproject.wsgi.application'
